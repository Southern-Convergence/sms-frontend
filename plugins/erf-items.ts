export default defineNuxtPlugin(() => {
  ...
  const position = ['Teacher II', 'Teacher III', 'SPED Teacher I', 'SPED Teacher II', 'SPED Teacher III', 'Master Teacher I', 'Master Teacher II', 'Head Teacher I', 'Head Teacher II', 'Head Teacher III', 'Head Teacher IV', 'Head Teacher V', 'Head Teacher VI', 'Principal I', 'Principal II', 'Principal III', 'Principal IV',]
